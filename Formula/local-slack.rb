class LocalSlack < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "b7410e334424b10492683ce149be42f2e951cf7e331458ec1429a45f431131f9"
    end
    on_intel do
      url "https://github.com/parvalabs/local-slack/releases/download/v0.1.0/local-slack-darwin-x64.tar.gz"
      sha256 "74bb7573b1a542888f38d4d86d126a8ade254f3831c79b9fae4a22f2599cec89"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "784b68e106845d72f73dad9bf254d662c0149a6e951a01bbae874a6120f94fc0"
    end
    on_intel do
      url "https://github.com/parvalabs/local-slack/releases/download/v0.1.0/local-slack-linux-x64.tar.gz"
      sha256 "b462325b2a7c929527a731052fd724ab56a3adecc145c588771f2a815ed2abe6"
    end
  end
